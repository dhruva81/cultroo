...
<x-container>
    <div 
            ...
            x-show="show" 
            class="rounded-md bg-green-100 p-4 my-4">
        <div class="flex">
            ...
            <div class="ml-3">
                <p class="text-sm leading-5 font-medium text-green-800">
                    {!! session('success') !!}
                    @if (session('view_link'))
                    <span class="block sm:ml-2 sm:inline-block">
                        <a target="_blank" href="{{ session('view_link') }}" class="text-green-900 font-bold underline"> View <span aria-hidden="true">&rarr;</span></a>
                    </span>
                    @endif
                </p>
            </div>
...
<x-container>
    <div 
      ...
      x-init="setTimeout(() => show = false, 4000)"
      x-show="show" 
      class="rounded-md bg-red-100 p-4 my-4">
        <div class="flex">
            <div class="flex-shrink-0">
