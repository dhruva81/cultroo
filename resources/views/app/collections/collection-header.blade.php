<x-header
    ...
    badge="Collection | #{{ $collection->id }}"
...
{{--            @endif--}}
        ...
        <div x-data="{ open: false }" class="ml-3 relative">
            ...
            <div x-show="open" x-description="Dropdown panel, show/hide based on dropdown state."
                ...
                <x-href-dropdown-link
                    ...
                    label="Go back"
                    href="{{ route('collections.datatable') }}"
                />
            </div>
        </div>
    ...
    <x-slot name="navSlot">
        ...
        <a href="{{ route('collections.show', ['collection' => $collection, 'tab' => 'series']) }}"
            @class([
            ...
            'border-indigo-500 text-indigo-600' => Route::currentRouteName() === 'collections.show' && $tab === 'series',
            'border-transparent text-gray-600' => Route::currentRouteName() !== 'collections.show' && $tab === 'series',
         ])>
        ...
        <a href="{{ route('collections.show', ['collection' => $collection, 'tab' => 'shorts']) }}"
            @class([
                'flex items-center hover:text-gray-700 hover:border-gray-300 whitespace-nowrap pb-4 px-1 border-b-2 border-transparent  font-medium text-sm',
                'border-indigo-500 text-indigo-600' => Route::currentRouteName() === 'collections.show' && $tab === 'shorts',
                'border-transparent text-gray-600' => Route::currentRouteName() !== 'collections.show' && $tab === 'shorts',
             ])>
        ...
        <a href="#"
            ...
            'border-indigo-500 text-indigo-600' => Route::currentRouteName() === 'collections.settings',
            'border-transparent text-gray-600' => Route::currentRouteName() !== 'collections.settings',
         ])>
            <x-heroicon-o-cog
                @class([
                     'group-hover:text-gray-500 -ml-0.5 mr-2 h-5 w-5',
